...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\columnwidth]{figures/sensitivity_heatmap}
...
quadratic prefill reduction; (b)~HBM channels provide linear decode
improvement; (c)~Core count shows diminishing returns with negative
ROI beyond 128 cores.}
\label{fig:oat}
\end{figure*}
