...
class Softmax(Operator):
    ...
    def _compute_reduction_tree_metrics(
        ...
        # Softmax has 2 reduction passes (max and sum), 1 element-wise pass (normalize)
        reduction_passes = [
            ("row_max", ReductionType.ROW_MAX),
            ("row_sum", ReductionType.ROW_SUM),
        ]
